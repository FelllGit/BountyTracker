...
import { adminBugBountyTableColumns } from "@/components/admin/bugBunty/bugBountyTableColumns";
import { Checkbox } from "@/components/ui/checkbox";

const PAGE_SIZE = 20;

const AdminBugBountyTable = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {error ? (
        ...
        <DataTable
          columns={adminBugBountyTableColumns}
          data={displayedData}
          isLoading={isLoading}
          sorting={sorting}
...
export default AdminBugBountyTable;
