...
import { useGetW3SecurityContestsAmountByPlatformBB } from "@/hooks/useGetAmountByPlatformBB";
...
export function AmountByPlatformBB() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetW3SecurityContestsAmountByPlatformBB();
